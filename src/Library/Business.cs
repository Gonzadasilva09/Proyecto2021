...
namespace Telegram
{
    ...
    public class Business : User
    {
        ...
        public void MakeOffer(Ratings ratings, string type, string prodname, int prodquantity, Units produnit, string proddirection, int prodprice,List<Category> categories)
        {
            Offer offer = new Offer(ratings, type, prodname, prodquantity, produnit, proddirection, prodprice, categories);
